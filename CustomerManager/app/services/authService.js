(function () {
    ...
    function authService($http, $q, localStorageService, appSettings) {
        ...
        var _saveRegistration = function (registration) {
            ...
            return $http.post(appSettings.apiServiceBaseUri + 'api/account/register', registration).then(function (response) {
                return response;
            });
        };
        ...
        var _login = function(loginData) {
            ...
            $http.post(appSettings.apiServiceBaseUri + 'token', data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
                if (loginData.useRefreshTokens) {
